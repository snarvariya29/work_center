...
import 'package:get_work/src/shared/app_constants.dart';
...
class _LogInScreenState extends State<LogInScreen> {
  ...
  final TextEditingController usernameController =
      TextEditingController(text: 'harshita@gmail.com');
  final TextEditingController passwordController =
      TextEditingController(text: 'Harshita@123');
                        ...
                        child: Column(
                          children: [
                            ...
                            TextButton(
                                ...
                                child: const Text(
                                    AppConstants.buttonTextDontHaveAccount))
                          ],
                        )),
                  )
                ],
